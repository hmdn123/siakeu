                                        ...
                                        <select name="keterangan"
                                            ...
                                            @foreach ($jenis as $jenis)
                                                <option value="{{ $jenis->keterangan }}" data-kode="{{ $jenis->kode }}"
                                                    data-kode2="{{ $jenis->kode }}">{{ $jenis->keterangan }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control col-md-6 value="
                                                    {{ old('kode2') }}" id="kode2" disabled="">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control value=" {{ old('kode') }}"
                                                    id="kode" name="kode" style="visibility: hidden;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('detail') is-invalid @enderror"
                                            name="detail" value="{{ old('detail') }}" id="detail">
                                    ...
                                    <div class="col-md-6">
                                        <label for="detail" class="form-label">Tanggal Input</label>
                                            ...
                                            <td>
                                                @if ($transaksi->user->name === Auth::user()->name)
                                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                        action="{{ url('transaksi/delete', $transaksi->id) }}"
                                                        method="POST">
