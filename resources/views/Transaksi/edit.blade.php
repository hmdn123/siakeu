        ...
        <div class="card-body">
          ...
          <form action="{{ url('/transaksi/update', $transaksi->id) }}" method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-4">
                <select name="keterangan" class="form-select" @error('keterangan') is-invalid @enderror" id="jenis">
                  ...
                  <option value="{{ $jenis->keterangan }}" data-kode="{{ $jenis->kode }}" {{ $jenis->keterangan == $transaksi->keterangan ? 'selected' : '' }}>{{ $jenis->keterangan }}</option>
                  @endforeach
                </select>
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control @error('kode') is-invalid @enderror" value="{{ old('kode', $transaksi->kode) }}" id="kode" name="kode">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-4">
                <select name="jenis" class="form-select @error('jenis') is-invalid @enderror">
                  <option selected disabled value="">Choose...</option>
                  <option value="Debit" @if($transaksi->jenis == "Debit") selected @endif>Debit | Pemasukan</option>
                  <option value="Kredit" @if($transaksi->jenis == "Kredit") selected @endif>Kredit | Pengeluaran</option>
                </select>
                <!-- error message untuk jenis -->
                @error('jenis')
                <div class="alert alert-danger mt-2">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control @error('detail') is-invalid @enderror" name="detail" value="{{ $transaksi->detail }}" id="detail">
