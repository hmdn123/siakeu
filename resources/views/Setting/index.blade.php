          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $data->role }}</td>
                <td>
                  <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('setting.destroy', $data->id) }}" method="POST">
                    <a class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#EditAccount_{{ $data->id }}"><i class="bi bi-pencil-square"></i> Edit</a>
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="modal-body">
                      <form action="{{ route('setting.update', $data->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ $data->password }}" id="password">
