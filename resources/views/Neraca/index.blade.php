          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                @php
                $Debit = App\Models\Transaksi::where('kode', $data->kode)->where('jenis', 'Debit')->sum('nominal');
                $Kredit = App\Models\Transaksi::where('kode', $data->kode)->where('jenis', 'Kredit')->sum('nominal');
                $Saldo = $Debit - $Kredit;
                @endphp
                <td>@currency($Debit)</td>
                <td>@currency($Kredit)</td>
                <td class="fw-bold">@currency($Saldo)</td>
              </tr>
              @endforeach
            </tbody>
          </table>
